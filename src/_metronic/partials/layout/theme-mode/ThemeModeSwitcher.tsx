      ...
      >
        <div className="menu-item px-3 my-0">
          ...
          >
            ...
            <span className="menu-title">{intl.formatMessage({ id: "COMMON.LIGHT" })}</span>
          </a>
        </div>
        ...
        <div className="menu-item px-3 my-0">
          ...
          >
            ...
            <span className="menu-title">{intl.formatMessage({ id: "COMMON.DARK" })}</span>
          </a>
        </div>
        ...
        <div className="menu-item px-3 my-0">
          ...
          >
            ...
            <span className="menu-title">{intl.formatMessage({ id: "COMMON.SYSTEM" })}</span>
          </a>
        </div>
      </div>
    </>
